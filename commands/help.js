...
module.exports = {
  ...
  // 🆕 export ฟังก์ชันนี้ออกมาด้วย (นอกเหนือจาก data/execute ที่ระบบโหลดคำสั่งต้องการ)
  // เพื่อให้ server.js เรียกใช้สร้างลิงก์เชิญบอทในหน้า Server Picker ของ Dashboard ได้
  // (ปุ่ม "เชิญบอท" สำหรับเซิร์ฟที่ยังไม่มีบอทอยู่) — ใช้ฟังก์ชันเดียวกันเป๊ะ ไม่เขียนซ้ำ
  // เพื่อให้สิทธิ์ที่บอทขอตอนเชิญ "ตรงกันเสมอ" ไม่ว่าจะเชิญจาก /help ในดิสคอร์ด หรือ
  // จากหน้าเว็บ Dashboard ก็ตาม
  buildInviteUrl,
