...
// ❌→↩️ [21 ก.ย. 2569] เคยลองเพิ่ม "เพดานแข็ง" จำกัดไม่เกิน 60 เฟรมตรงนี้ (บังคับข้าม
// เฟรมถี่ขึ้นเรื่อยๆ จนกว่าจำนวนเฟรมจะไม่เกิน 60 ไม่ว่าขั้น 1-2 ด้านล่างจะคำนวณไว้ยังไง)
// แต่น้องหนาวทดสอบแล้วพบว่ามันแค่ทำให้ภาพเคลื่อนไหวกระตุกขึ้น (ข้ามเฟรมถี่ขึ้น) โดยไม่ได้
// ช่วยเรื่องขนาดไฟล์เลย (ขนาดไฟล์ GIF ขึ้นกับความละเอียด + จำนวนสี ต่อเฟรมเป็นหลัก ไม่ได้
// ขึ้นกับจำนวนเฟรมมากเท่าที่คิด) เลยเอาออก กลับไปใช้แค่ขั้น 1-2 (ปรับตามเวลาที่คาดว่าจะใช้
// จริง) เหมือนเดิม — ถ้าจะกลับมาเพิ่มอีกในอนาคต ให้คิดเรื่อง "ลดขนาดไฟล์" แยกเป็นอีกกลไก
// ต่างหาก (เช่น ลด palette สี หรือลดความละเอียด) ไม่ใช่ใช้การดรอปเฟรมเพื่อลดไฟล์
